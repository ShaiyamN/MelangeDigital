import{r as n,j as e,W as O,N as R,i as M,F as A}from"./index-CuKC8I8T.js";import{c as N}from"./index-UoIplL0Z.js";const G=()=>{const c=({number:t,suffix:i,label:s})=>{const[m,p]=n.useState(0);return n.useEffect(()=>{let d=0;const l=t/(1200/16),f=setInterval(()=>{d+=l,d>=t?(p(t),clearInterval(f)):p(Math.floor(d))},16);return()=>clearInterval(f)},[t]),e.jsxs("div",{style:{textAlign:"center"},children:[e.jsxs("h3",{style:{fontSize:"clamp(36px, 6vw, 64px)",fontWeight:800,margin:0,color:"#7a1ef1"},children:[m,e.jsx("span",{style:{fontSize:"clamp(18px, 3vw, 32px)",marginLeft:"6px"},children:i})]}),e.jsx("p",{style:{marginTop:"10px",fontSize:"clamp(14px, 1.5vw, 18px)",fontWeight:500,color:"#333"},children:s})]})},[y,v]=n.useState(null),[C,x]=n.useState(!1),[T,I]=n.useState(!1),[g,w]=n.useState(!1),[j,S]=n.useState(""),[P,W]=n.useState(!1);n.useEffect(()=>{const t=()=>{W(window.innerWidth<576)};return t(),window.addEventListener("resize",t),()=>window.removeEventListener("resize",t)},[]);const B=t=>{v(t),x(!1),setTimeout(()=>x(!0),60)},k=()=>{x(!1),setTimeout(()=>v(null),260)},D=async t=>{t.preventDefault(),S(""),w(!0);try{const i=t.currentTarget,s=new FormData(i);await fetch("https://crm.zoho.in/crm/WebToLeadForm",{method:"POST",mode:"no-cors",body:s}),I(!0),i.reset()}catch{S("Something went wrong. Please try again.")}finally{w(!1)}},z=[{frontTitle:`Content Strategy
& SEO Optimization`,image:"/influencer_marketing/img/images/Content_Strategy_SEO_Optimization.png",emoji:"📈",title:"Content Strategy & SEO Optimization",desc:"Strategic planning meets SEO best practices for maximum impact",list:["Complete content inventory and assessment","Content gap identification and opportunity mapping","Keyword research and strategic integration","Search intent-driven content planning","On-page SEO optimization techniques","Strategic roadmap for content improvement"]},{frontTitle:`Social Media &
Video Content`,image:"/influencer_marketing/img/images/Social_Media_Video_Content.jpg",emoji:"🎬",title:"Social Media & Video Content",desc:"Platform-specific content that builds community and drives engagement",list:["Tailored content strategy per platform","Engagement-focused post planning and scheduling","Trend-leveraging content creation","Concept development and scriptwriting","Professional video production and editing","Platform-native format optimization"]},{frontTitle:`Long & Short-Form
Content Creation`,image:"/influencer_marketing/img/images/Long_Short_Form_Content_Creation.png",emoji:"✍️",title:"Long & Short-Form Content Creation",desc:"Versatile content that meets your audience where they are",list:["In-depth long-form articles and guides","Snackable short-form content for quick consumption","SEO-optimized blog posts and articles","Thought leadership content development","Authority-building editorial calendars","Value-driven content that educates and entertains"]},{frontTitle:`Visual Content
& Copywriting`,image:"/influencer_marketing/img/images/Visual_Content_Copywriting.png",emoji:"🎨",title:"Visual Content & Copywriting",desc:"Compelling narratives and eye-catching visuals that inspire action",list:["Custom graphics and social media assets","Infographic design and data visualization","Brand-aligned visual content creation","Brand voice development and refinement","Conversion-focused copywriting","Copy that builds brand loyalty and recognition"]}],o=y!==null?z[y]:null,[_,L]=n.useState(0);return e.jsxs("div",{className:"overflow-hidden",children:[e.jsxs(O,{children:[e.jsx("title",{children:"Content Strategy & Production Services | Mélange Digital"}),e.jsx("meta",{name:"description",content:"Content strategy and production for travel and tourism brands. From destination stories to campaign assets, Mélange Digital plans and produces work that converts."}),e.jsx("meta",{name:"viewport",content:"width=device-width, initial-scale=1.0"}),e.jsx("link",{rel:"preconnect",href:"https://fonts.googleapis.com"}),e.jsx("link",{rel:"preconnect",href:"https://fonts.gstatic.com",crossOrigin:""}),e.jsx("link",{href:"https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:opsz,wght@12..96,200..800&display=swap",rel:"stylesheet"}),e.jsx("link",{rel:"canonical",href:"https://melangedigital.co/services/content-strategy-and-production"}),e.jsx("script",{type:"application/ld+json",children:`
      {
    ...
    `})]}),e.jsx("style",{children:`
      ...
      `}),e.jsx(R,{}),e.jsxs("section",{style:{position:"relative",overflow:"hidden",background:"#ffffff",fontFamily:'"Bricolage Grotesque", sans-serif',width:"100%",minHeight:"100vh",display:"flex",alignItems:"center"},children:[e.jsx("style",{children:`
