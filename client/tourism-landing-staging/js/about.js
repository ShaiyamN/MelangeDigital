...
(function initAboutSphere() {
  function start() {
    if (typeof window.__initAboutNetworkSphere !== "function") return;
    document.querySelectorAll("[data-network-sphere]").forEach(function (root) {
  ...
  var existing = document.querySelector('script[src*="network-sphere"]');
