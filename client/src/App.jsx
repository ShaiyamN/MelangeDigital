...
/** Static landing lives in public/tourism — leave the SPA with a full document load. */
function TourismLandingRedirect() {
  useEffect(() => {
    window.location.replace("/tourism/");
  }, []);
  return null;
}
    ...
    <>
      ...
      <Suspense fallback={<div className="min-h-screen flex items-center justify-center">Loading...</div>}>
        <Routes>
          ...
          {/* If the SPA ever lands on /tourism, hard-navigate to the static landing */}
