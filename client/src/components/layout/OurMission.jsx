...
const OurMission = () => {
  return (
    <div className="lg:px-20 px-5 lg:pb-[20px] pb-section-y lg:pt-10 pt-20 font-bricolage max-container">
      <div className="flex lg:flex-row flex-col-reverse item-center justify-center lg:space-x-20">
        ...
        <div className="lg:w-[60%] flex flex-col justify-center">
          <h2 className="font-bold text-display lg:leading-[57px] leading-[48px] ">
