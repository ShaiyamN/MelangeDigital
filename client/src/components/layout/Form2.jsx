...
const Form2 = ({ onClose }) => {
  return (
    <div className="fixed inset-8 font-nunito bg-white left-[0%] z-50 right-[0%] top-[0%] lg:top-[11%] xxl:top-[9.8%] 2xl:top-[9.8%] h-screen overflow-y-auto">
      <button
        onClick={onClose}
        className="absolute z-50 top-8 lg:top-[5%] right-[5%]"
      >
