...
const CSS = [
  ...
  `${ASSET}/css/melange.css?v=20260828u`,
];
...
const WorkTourism = () => {
  const cssReady = useTourismBoot("wrk", CSS, SCRIPT_BASES);
  ...
  return (
    <>
      <Helmet>
        ...
        <style type="text/css">{tourismNavCss("wrk")}</style>
      </Helmet>

      <TourismShell slug="wrk" cssReady={cssReady} markup={markup} />
    </>
  );
};

export default WorkTourism;
