...
// Shared plumbing for marketing pages mounted from extracted markup.
// Namespaced by `slug` so pages never clash over stylesheets, scripts, or <base>.

export const MARKETING_ASSET = "/destination-marketing-agency";
...
export const marketingNavCss = (slug) => `
...
export function useMarketingBoot(slug, css, scripts) {
  ...
  useEffect(() => {
    ...
    baseEl.setAttribute("href", `${MARKETING_ASSET}/`);
...
export function MarketingShell({ slug, cssReady, markup }) {
  return (
    <>
      <Navbar />
      <div
